...
{using Microsoft.Extensions.Configuration;
    ...
    public class FSIController : Controller
    {
        ...
        public FSIController(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult ShowData(string LiquidLimit, string PlasticLimit)
        {
